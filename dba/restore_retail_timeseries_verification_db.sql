...
-- declare vars
declare @num_dbs int = 5
declare @db_name varchar(100) = 'retaildb_timeseries_verification'
declare @new_mdf_name varchar(100) = 'C:\SQLData\retaildb_timeseries_verification.mdf'
declare @new_ldf_name varchar(100) = 'C:\SQLData\retaildb_timeseries_verification.ldf'
declare @back_up_name varchar(100) = 'C:\SQLData\retaildb_timeseries_verification.bak'
declare @current_db_name varchar(100)
declare @new_db_name varchar(100)



-- roll dbs and drop last db
declare @db_to_drop varchar(100) = @db_name + '_' + cast(@num_dbs as varchar(2))
...
-- roll over old dbs
declare @current_index int = @num_dbs
