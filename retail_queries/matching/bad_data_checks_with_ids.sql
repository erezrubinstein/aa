...
having count(*) > 1)
select s.id, s.company_id, a.street_number, a.street, a.municipality, a.governing_district, a.postal_area, d.cnt 
from stores s 
inner join addresses a on s.id = a.store_id
inner join dupes as d on s.company_id = d.company_id
...
select store_id from qa_report_demographics_vw where home_population < 10
