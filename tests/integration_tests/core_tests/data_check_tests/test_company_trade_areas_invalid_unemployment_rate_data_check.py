...
from core.data_checks.implementation.company_checks.economics.company_trade_areas_invalid_unemployment_rate_data_check import CompanyTradeAreasInvalidUnemploymentRateDataCheck
...
class TestCompanyTradeAreasInvalidUnemploymentRateDataCheck(unittest.TestCase):
    conn = None
    mds = None
    ...
    def setUp(self):
        ...
        self.mds.trade_area.insert([
            ...
            create_trade_area(self.ta2, self.co1, 3, 0, 5, None),
            create_trade_area(self.ta3, self.co1, 4, 2, -1, 300)
        ])
    ...
    def test_company_trade_areas_workforce_adds_up(self):
        ...
        checker = CompanyTradeAreasInvalidUnemploymentRateDataCheck(self.mds, self.companies[0], self.company_dict)
    ...
    def test_under_10_percent_tolerance(self):
        self.mds.trade_area.insert([
            ...
            create_trade_area(ObjectId(), self.co2, 2, 2, 4, 500),
        ])

        checker = CompanyTradeAreasInvalidUnemploymentRateDataCheck(self.mds, self.companies[1], self.company_dict)
        result = checker.check()
