...
dn_FEMALE_18TO34.value as FEMALE_18TO34,
dn_X10003_X.value as X10003_X,
dn_X10008_X.value as X10008_X,
dn_X8031_X.value as X8031_X,
dn_X8035_X.value as X8035_X,
dn_X4029_X.value as X4029_X,
dn_X4032_X.value as X4032_X,
dn_X10006_X.value as X10006_X,
dn_X10007_X.value as X10007_X,
dn_X10009_X.value as X10009_X,
dn_HINC_35TO100K.value as HINC_35TO100K,
dn_PROX_MSGROCERY.value as PROX_MSGROCERY
from stores s
...
left join demographic_numvalues dn_X8029_X on dn_X8029_X.trade_area_id = t.trade_area_id and dn_X8029_X.data_item_id = 2592
...
left join demographic_numvalues dn_FEMALE_18TO34 on dn_FEMALE_18TO34.trade_area_id = t.trade_area_id and dn_FEMALE_18TO34.data_item_id = 2812
...
left join demographic_numvalues dn_X8031_X on dn_X8031_X.trade_area_id = t.trade_area_id and dn_X8031_X.data_item_id = 2984
left join demographic_numvalues dn_X8035_X on dn_X8035_X.trade_area_id = t.trade_area_id and dn_X8035_X.data_item_id = 2985
left join demographic_numvalues dn_X4029_X on dn_X4029_X.trade_area_id = t.trade_area_id and dn_X4029_X.data_item_id = 2986
left join demographic_numvalues dn_X4032_X on dn_X4032_X.trade_area_id = t.trade_area_id and dn_X4032_X.data_item_id = 2987
left join demographic_numvalues dn_X10006_X on dn_X10006_X.trade_area_id = t.trade_area_id and dn_X10006_X.data_item_id = 2989
left join demographic_numvalues dn_X10007_X on dn_X10007_X.trade_area_id = t.trade_area_id and dn_X10007_X.data_item_id = 2990
left join demographic_numvalues dn_X10009_X on dn_X10009_X.trade_area_id = t.trade_area_id and dn_X10009_X.data_item_id = 2992
left join demographic_numvalues dn_HINC_35TO100K on dn_HINC_35TO100K.trade_area_id = t.trade_area_id and dn_HINC_35TO100K.data_item_id = 3007
left join demographic_numvalues dn_PROX_MSGROCERY on dn_PROX_MSGROCERY.trade_area_id = t.trade_area_id and dn_PROX_MSGROCERY.data_item_id = 3008