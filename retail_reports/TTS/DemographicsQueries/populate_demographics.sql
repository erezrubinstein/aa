...
dn_ACSUNT1DET.value + dn_ACSUNT1ATT.value + dn_ACSUNT2.value + dn_ACSUNT3.value + dn_ACSUNT5.value + dn_ACSUNT10.value + dn_ACSUNT20.value + dn_ACSUNT50UP.value as HU_TOTADJ,
dn_ACSUNT1DET.value + dn_ACSUNT1ATT.value as HU_SINGFAM,
dn_ACSUNT2.value + dn_ACSUNT3.value + dn_ACSUNT5.value + dn_ACSUNT10.value + dn_ACSUNT20.value + dn_ACSUNT50UP.value as HU_MULTI
from stores s
...
left join demographic_numvalues dn_HINC_50KPLUS_CY on dn_HINC_50KPLUS_CY.trade_area_id = t.trade_area_id and dn_HINC_50KPLUS_CY.data_item_id = 2805 and dn_HINC_50KPLUS_CY.template_name = 'Mattress_June13'
left join demographic_numvalues dn_HINC_75KPLUS_CY on dn_HINC_75KPLUS_CY.trade_area_id = t.trade_area_id and dn_HINC_75KPLUS_CY.data_item_id = 2806 and dn_HINC_75KPLUS_CY.template_name = 'Mattress_June13'
left join demographic_numvalues dn_HINC_100KPLUS on dn_HINC_100KPLUS.trade_area_id = t.trade_area_id and dn_HINC_100KPLUS.data_item_id = 2807 and dn_HINC_100KPLUS.template_name = 'Mattress_June13'
left join demographic_numvalues dn_POP_25PLUS_CY on dn_POP_25PLUS_CY.trade_area_id = t.trade_area_id and dn_POP_25PLUS_CY.data_item_id = 2808 and dn_POP_25PLUS_CY.template_name = 'Mattress_June13'
left join demographic_numvalues dn_POP_30PLUS_CY on dn_POP_30PLUS_CY.trade_area_id = t.trade_area_id and dn_POP_30PLUS_CY.data_item_id = 2809 and dn_POP_30PLUS_CY.template_name = 'Mattress_June13'
left join demographic_numvalues dn_AGG_INCOME on dn_AGG_INCOME.trade_area_id = t.trade_area_id and dn_AGG_INCOME.data_item_id = 2810 and dn_AGG_INCOME.template_name = 'Mattress_June13'
